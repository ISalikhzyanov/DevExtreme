"use client"
export { ExplicitTypes } from "@ISalikhzyanov/devextreme/ui/context_menu";
...
import type { dxContextMenuItem, ContentReadyEvent, DisposingEvent, HiddenEvent, HidingEvent, InitializedEvent, ItemClickEvent, ItemContextMenuEvent, ItemRenderedEvent, PositioningEvent, ShowingEvent, ShownEvent } from "@ISalikhzyanov/devextreme/ui/context_menu";
...
import type { HorizontalAlignment, VerticalAlignment, Direction, template, PositionAlignment, SubmenuShowMode } from "@ISalikhzyanov/devextreme/common";
