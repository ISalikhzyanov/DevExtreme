...
import dxDropDownBox, {
    Properties
} from "@ISalikhzyanov/devextreme/ui/drop_down_box";

import { Component as BaseComponent, IHtmlOptions, ComponentRef, NestedComponentMeta } from "./core/component";
import NestedOption from "./core/nested-option";

import type { ChangeEvent, ClosedEvent, CopyEvent, CutEvent, DisposingEvent, EnterKeyEvent, FocusInEvent, FocusOutEvent, InitializedEvent, InputEvent, KeyDownEvent, KeyUpEvent, OpenedEvent, PasteEvent, ValueChangedEvent } from "@ISalikhzyanov/devextreme/ui/drop_down_box";
...
import type * as DropDownBoxTypes from '@ISalikhzyanov/devextreme/ui/drop_down_box_types';
