...
import { dxTreeMapNode } from '@ISalikhzyanov/devextreme/viz/tree_map';
...
export class DxoTreeMapTooltipComponent extends NestedOption implements OnDestroy, OnInit  {
    ...
    @Input()
    get customizeTooltip(): ((info: { node: dxTreeMapNode, value: number, valueText: string }) => Record<string, any>) | undefined {
        return this._getOption('customizeTooltip');
    }
    set customizeTooltip(value: ((info: { node: dxTreeMapNode, value: number, valueText: string }) => Record<string, any>) | undefined) {
