...
import { DashStyle, ChartsColor, HatchDirection } from '@ISalikhzyanov/devextreme/common/charts';
...
export class DxoChartCommonSeriesSettingsHoverStyleComponent extends NestedOption implements OnDestroy, OnInit  {
    @Input()
