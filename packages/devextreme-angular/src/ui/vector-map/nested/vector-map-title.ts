...
import { HorizontalAlignment, VerticalEdge } from '@ISalikhzyanov/devextreme/common';
...
export class DxoVectorMapVectorMapTitleComponent extends NestedOption implements OnDestroy, OnInit  {
    @Input()
    get font(): Font {
