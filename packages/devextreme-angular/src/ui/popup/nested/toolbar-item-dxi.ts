...
import { ToolbarLocation } from '@ISalikhzyanov/devextreme/ui/popup';
...
export class DxiPopupToolbarItemComponent extends CollectionNestedOption implements AfterViewInit,
    IDxTemplateHost {
    @Input()
