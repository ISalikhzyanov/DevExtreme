...
import { HeaderFilterSearchConfig, HeaderFilterTexts } from '@ISalikhzyanov/devextreme/common/grids';
...
export class DxoTreeListTreeListHeaderFilterComponent extends NestedOption implements OnDestroy, OnInit  {
    @Input()
