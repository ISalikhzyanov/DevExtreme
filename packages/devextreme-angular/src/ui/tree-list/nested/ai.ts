...
import { AIColumnMode } from '@ISalikhzyanov/devextreme/common/grids';
...
export class DxoTreeListAiComponent extends NestedOption implements OnDestroy, OnInit  {
    @Input()
...
export class DxoTreeListAiModule { }
